...
Original file is located at
    https://colab.research.google.com/github/MitjaGo/BAR/blob/main/BAR.ipynb
...
def on_button_clicked(b):
    with output:
        ...
        df.to_csv ('~/Downloads/Apartmaji-Adria-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df1.to_csv ('~/Downloads/Standard-Mobile-Homes-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df2.to_csv ('~/Downloads/Premium-Mobile-Homes-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df3.to_csv ('~/Downloads/Hotel-Convent-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df4.to_csv ('~/Downloads/Olive Suites-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df5.to_csv ('~/Downloads/Vile-brez-balkona-4-Phobs.csv', index=None, header=None)
...
def on_button_clicked(b):
    with output:
        ...
        df6.to_csv ('~/Downloads/Vile-z-balkonom-4-Phobs.csv', index=None, header=None)
...
st.download_button(
    label="Download Vile z balkomom CSV",
    data=csv,
    file_name="Vile-z-balkonom-4-Phobs.csv",
    mime="text/csv",
